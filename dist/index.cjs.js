    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 66 66" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("linearGradient", { x1: "82.8104%", y1: "42.6428874%", x2: "12.4312954%", y2: "56.6030628%", id: "linearGradient-s1" },
                React__default['default'].createElement("stop", { "stop-color": "#50D546", offset: "0%" }),
                React__default['default'].createElement("stop", { "stop-color": "#FFEB17", offset: "51.2485211%" }),
                React__default['default'].createElement("stop", { "stop-color": "#FF8200", offset: "100%" })),
            React__default['default'].createElement("linearGradient", { x1: "16.9903565%", y1: "13.8851189%", x2: "100%", y2: "50%", id: "linearGradient-s2" },
                React__default['default'].createElement("stop", { "stop-color": "#003DE9", offset: "0%" }),
                React__default['default'].createElement("stop", { "stop-color": "#FF0058", offset: "38.0035203%" }),
                React__default['default'].createElement("stop", { "stop-color": "#81BB47", offset: "100%" }))),
        React__default['default'].createElement("g", { id: "p2-1", stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" },
